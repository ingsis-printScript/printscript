...
class AstFactory {
    ...
    fun createVariableDeclarator(symbol: SymbolExpression, type: org.example.common.enums.Type, value: OptionalExpression = OptionalExpression.NoExpression, range: Range = basicRange
